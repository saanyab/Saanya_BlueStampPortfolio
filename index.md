...
# Second Milestone
I successfully achieved my second milestone by seamlessly integrating a person sensor onto the solderless breadboard, and flawlessly executing the program without encountering any errors. By incorporating this groundbreaking feature, my aim was to enhance the awareness of visually impaired individuals regarding their surroundings, enabling them to gain a comprehensive understanding of the objects in their path. The process of wiring proved to be unexpectedly challenging, demanding considerable troubleshooting efforts to ensure precise connections. Overcoming obstacles encountered during my initial milestone, such as a malfunctioning LED and numerous code errors, I have diligently resolved all issues, resulting in a fully functional system. Looking ahead, my imminent objective involves transferring the project onto the perfboard, thus nearing its completion.
